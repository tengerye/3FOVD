...
- Plot the classification loss of some run.
  ...
  ```shell
  python tools/analysis_tools/analyze_logs.py plot_curve 20230913_102629.log --keys loss_cls --legend loss_cls
  ```

- Plot the classification and regression loss of some run, and save the figure to a pdf.

  ```shell
  python tools/analysis_tools/analyze_logs.py plot_curve 20230913_102629.log --keys loss_cls loss_bbox --out losses.pdf
  ```
...
- Compute the average training speed.
  ...
  ```shell
  python tools/analysis_tools/analyze_logs.py cal_train_time 20230913_102629.log [--include-outliers]
  ```
