...
data_root = '/home/zming/cv_models/mmdetection/data/coco/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/home/zming/cv_models/mmdetection/data/coco/annotations/instances_train2017.json',
        img_prefix='/home/zming/cv_models/mmdetection/data/coco/train2017/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        '/home/zming/cv_models/mmdetection/data/coco/annotations/instances_val2017.json',
        img_prefix='/home/zming/cv_models/mmdetection/data/coco/val2017/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
