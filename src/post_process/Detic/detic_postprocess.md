1. Follow the [official install instruction](https://github.com/facebookresearch/Detic/blob/main/docs/INSTALL.md) to install the environment.
2. 将此Detic文件夹下的文件除了readme.md外全部移动到官方仓库的根目录下
3. 运行start.sh脚本
